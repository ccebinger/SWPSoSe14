...
class Bytecode {
  ...
  */
  ...
  /**
  * The ctor to create a Bytecode class object for lambda bytecode generation.
  *
  * @param pool     the constantpool whicjh will be used to reference to the method and classes in the bytecode
  * @param name     the name of the class for which the bytecode is generated
  * @param is_lambda_code   indicates if the code is generated for an anonymous class (lambda)
  */
  Bytecode(ConstantPool& pool, std::string& name, bool is_lambda_code = true);
  ...
  */
  ...
  /**
  * Returns the name of the class for which the bytecode is created.
  ...
  */
  ...
  /**
  * Adds bytecode to pop a variable with the given name the idx is used local variable stash.
  * (adds aload + idx to the bytecode)
  *
  * @param var_name     the name of the variable which should be popped and pushed into the stack
  * @return             the pointer of the current Bytecode class object
  */
  Bytecode* add_pop_variable_code(std::string& var_name);
  //GLOBAL STACK
  /**
  ...
  /**
  * Creates for a given length a valid method descriptor with java/lang/Objects as parameters.
  *
  * @param len            the count of parameters which should be created
  * @return               the valid descriptor
  */
  static std::string create_object_descriptor(size_t len);
  ...
  */
  ...
  /**
  * The class name for which the bytecode is generated.
  */
...
/**
 * The method generates the Java Bytecode for if statements which are represents the junctions in Rail.
 * The generated bytecode is the representation of the '< | x | > | Y | ^ | * | + ' Rail-command.
 *
 * @param state        the current state of the Bytecode class object
 */
void if_ByteCode(Bytecode::Current_state state);
//VARIABLES
