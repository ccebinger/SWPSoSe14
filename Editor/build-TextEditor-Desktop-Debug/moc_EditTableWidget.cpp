...
#include "../TextEditor/EditTableWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_EditTableWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 47, 11)
    ...
    "EditTableWidget\0cursorPositionChanged\0"
    "\0row\0col\0textChanged\0"
};
...
void EditTableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (EditTableWidget::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditTableWidget::cursorPositionChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (EditTableWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&EditTableWidget::textChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject EditTableWidget::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata_EditTableWidget.data,
      qt_meta_data_EditTableWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EditTableWidget.stringdata))
